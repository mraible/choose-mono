<template>
  <div>
    <h2 id="page-heading" data-cy="TagHeading">
      <span v-text="$t('blogApp.tag.home.title')" id="tag-heading">Tags</span>
      <div class="d-flex justify-content-end">
        ...
        >
          ...
          <span v-text="$t('blogApp.tag.home.createLabel')"> Create a new Tag </span>
        </router-link>
      </div>
    </h2>
    <br />
    <div class="alert alert-warning" v-if="!isFetching && tags && tags.length === 0">
      <span v-text="$t('blogApp.tag.home.notFound')">No tags found</span>
    </div>
        ...
        <thead>
          <tr>
            ...
            <th scope="row" v-on:click="changeOrder('name')">
              <span v-text="$t('blogApp.tag.name')">Name</span>
        ...
        <tbody>
          <tr v-for="tag in tags" :key="tag.id" data-cy="entityTable">
            ...
            <td class="text-right">
              <div class="btn-group">
                <router-link
                  :to="{ name: 'TagView', params: { tagId: tag.id } }"
                  tag="button"
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <span slot="modal-title"
        ><span id="blogApp.tag.delete.question" data-cy="tagDeleteDialogHeading" v-text="$t('entity.delete.title')"
          >Confirm delete operation</span
        ></span
      >
      <div class="modal-body">
        <p id="jhi-delete-tag-heading" v-text="$t('blogApp.tag.delete.question', { id: removeId })">
