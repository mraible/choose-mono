  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2 id="blogApp.blog.home.createOrEditLabel" data-cy="BlogCreateUpdateHeading" v-text="$t('blogApp.blog.home.createOrEditLabel')">
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('blogApp.blog.name')" for="blog-name">Name</label>
            <input
              type="text"
              class="form-control"
              name="name"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('blogApp.blog.handle')" for="blog-handle">Handle</label>
            <input
              type="text"
              class="form-control"
              name="handle"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('blogApp.blog.user')" for="blog-user">User</label>
